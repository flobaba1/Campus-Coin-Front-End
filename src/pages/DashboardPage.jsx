      ...
      <section className='dash-content'>
        <div className='dash-heading'>
          ...
          <div className='heading-actions'>
            ...
            <button className='income-btn' onClick={() => setModal('income')}>
              <Icon name='arrowup' size={15} /> Add income
            </button>
            <button className='primary-btn' onClick={() => setModal('expense')}>
        ...
        <div className='dashboard-grid'>
          ...
          <div className='right-stack'>
            <InsightCard loading={loading} onRead={() => {}} />
            <SavingTips />
          </div>
...
function CategoryBudgets({ saved }) {
  return (
...
function TransactionModal({
  ...
  return (
    <div className='modal-backdrop'>
      <div className={`transaction-modal ${ai ? 'ai-modal' : ''}`}>
        ...
        <div className='expense-tabs'>
          <button className={!income ? 'active' : ''}>Expense</button>
          <button className={income ? 'active' : ''}>Income</button>
        </div>
        <label>
          Amount
        ...
        <label>
          ...
          <div className='field-input'>
            ...
            <input
              ...
              placeholder='e.g. Campus Cafe, bus fare, textbook'
            />
          </div>
        </label>
        {(ai || description.trim().length > 0) && (
